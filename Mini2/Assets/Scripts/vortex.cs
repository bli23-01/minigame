...
public class vortex : MonoBehaviour
{
    ...
    float radius_speed = 0.1f; // 半径的扩散速度，2s变换到 1 radis;
    float angle_speed = 0.5f; // 弧度的改变速度，2s --> 2弧度

    float total_time = float.MaxValue; // 特效持续的时间;
    ...
    private void Start() 
    {
        this.GetComponent<MeshFilter>().mesh=GameManager.Main_mesh;
    }
    /*void Start()
    {
